...
APP_PARAMETERS = {
    ...
    "MatrixAdd": {
        ...
        "app_root_dir": "/home/fernando/git_research/gap_sdk/examples/autotiler/MatrixAdd",
    ...
    "MatMult": {
        # Path to the benchmark inside GAP SDK
        "app_root_dir": "/home/fernando/git_research/gap_sdk/examples/autotiler/MatMult",
        # Run script to execute the simulator
    ...
    "Mnist": {
        # Path to the benchmark inside GAP SDK
        "app_root_dir": "/home/fernando/git_research/gap_sdk/examples/autotiler/Mnist",
        # Run script to execute the simulator
    ...
    "Fir": {
        # Path to the benchmark inside GAP SDK
        "app_root_dir": "/home/fernando/git_research/gap_sdk/examples/autotiler/Fir",
        # Run script to execute the simulator
    ...
    "BilinearResize": {
        # Path to the benchmark inside GAP SDK
        "app_root_dir": "/home/fernando/git_research/gap_sdk/examples/autotiler/BilinearResize",
        # Run script to execute the simulator
    ...
    "memradtest": {
        # Path to the benchmark inside GAP SDK
        "app_root_dir": "/home/fernando/git_research/gap_sdk/examples/pmsis/memradtest",
        # Run script to execute the simulator
        "run_script": "test_apps/BilinearResize/run.sh",
        # how much time the app is expected to run in seconds
        "expected_run_time": 1,
